        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Card title="Concept">
            <p style={{ fontSize: '0.9rem' }}>
              ...
              <br /><br />
              Counterintuitively, switching <strong>doubles</strong> your chances of winning from <Latex math={String.raw`\sim 33\%`} /> to <Latex math={String.raw`\sim 66\%`} />. Monte Carlo simulations empirically prove this law of probability by running the game thousands of times.
            </p>
          </Card>
        </div>
