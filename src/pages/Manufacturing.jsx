        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Card title="Concept">
            <p style={{ fontSize: '0.9rem' }}>
              ...
              By simulating standard operations yielding <Latex math="\sim\mathcal{N}(\mu, \sigma^2)" /> limits across 30 days multiplied by failure rates, we can gauge risk exposure to miss orders.
            </p>
          </Card>
        </div>
