        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <Card title="Controls">
            ...
            <div style={{ marginTop: '2rem' }}>
              <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.2rem' }}>Exact Area (<Latex math="\int_0^\pi \sin(x) dx" />)</div>
          ...
          <Card title="Concept">
            <p style={{ fontSize: '0.9rem' }}>
              ...
              Here we evaluate <strong><Latex math="f(x) = \sin(x)" /> from 0 to <Latex math="\pi" /></strong>.
              <br/><br/>
