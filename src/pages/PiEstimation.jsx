...
cat(sprintf("Estimated Pi with %d points is: %f\\n", n_simulations, estimated_pi))`;
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Estimating Pi (<Latex math="\pi" />)</h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <Card title="Concept">
            <p style={{ fontSize: '0.9rem' }}>
              By inscribing a circle of radius 1 inside a 2x2 square, the ratio of the circle's area to the square's area is <strong><Latex math="\frac{\pi}{4}" /></strong>.
              <br/><br/>
              If we throw darts randomly into the square, the fraction of darts that hit inside the circle will approximate <Latex math="\frac{\pi}{4}" />.
            </p>
          </Card>
        </div>
