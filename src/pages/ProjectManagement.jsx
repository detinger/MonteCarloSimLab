        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <Card>
            ...
            <p className="text-muted" style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.9rem' }}>
              Histogram of simulated total project durations.<br /> <br /> Model factors in uncertainties across Procurement, Construction, and a fixed Inspection phase using Gaussian random variants (e.g. <Latex math={String.raw`\sim \mathcal{N}(\mu, \sigma^2)`} />).
            </p>
          </Card>
        </div>
      </div>
